...
public class Constants
{
    ...
    public static final long SPAWNING_TIME = 3000L;
    public static final long GAME_OVER_TIME = 2000L;
    ...
    public static double UFO_ANGLE_RANGE;
    public static final int UFO_SCORE = 40;
    public static final long UFO_SPAWN_RATE = 10000L;
    ...
    public static final long POWER_UP_DURATION = 10000L;
    public static final long POWER_UP_SPAWN_TIME = 8000L;
    public static final long SHIELD_TIME = 12000L;
    public static final long DOUBLE_SCORE_TIME = 10000L;
    public static final long FAST_FIRE_TIME = 14000L;
    public static final long DOUBLE_GUN_TIME = 12000L;
    public static final int SCORE_STACK = 1000;
    
    static {
        Constants.UFO_FIRE_RATE = 1000L;
        Constants.UFO_ANGLE_RANGE = 1.5707963267948966;
        SCORE_PATH = String.valueOf(FileSystemView.getFileSystemView().getDefaultDirectory().getPath()) + "\\Space_Ship_Game\\data.json";
    }
}